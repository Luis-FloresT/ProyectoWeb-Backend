    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metodo_pago', models.CharField(choices=[('transferencia', 'Transferencia'), ('tarjeta', 'Tarjeta'), ('efectivo', 'Efectivo')], default='transferencia', max_length=20)),
                ('comprobante_pago', models.ImageField(blank=True, null=True, upload_to='comprobantes/')),
                ('transaccion_id', models.CharField(blank=True, help_text='ID devuelto por la pasarela (Payphone, Stripe, etc)', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promocion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='fiesta.promocion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('C', 'Combo'), ('S', 'Servicio'), ('P', 'Promoción')], max_length=1)),
